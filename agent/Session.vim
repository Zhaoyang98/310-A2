...
nnoremap <silent>  :CocList buffers
noremap  
...
nnoremap <silent>  m :CocList marks
...
nnoremap ,le :VimtexErrors
nnoremap ,lc :VimtexClean
nnoremap ,li :VimtexInfo
nnoremap ,ltoc :VimtexTocToggle
nnoremap ,lv :VimtexView
nnoremap ,ll :VimtexCompile
...
nnoremap ,rs :CocRestart
nnoremap ,rb :CocRebuild
nnoremap ,sv :source $MYVIMRC
nnoremap ,ev :split $MYVIMRC
nnoremap ,3 :tab terminal
nnoremap ,2 :CreateTermial
nnoremap ,1 :VCreateTermial
...
nnoremap <silent> <C-B> :CocList buffers
nnoremap <silent> <C-P> :CocList files
xmap <silent> <S-Tab> <Plug>(coc-range-select-backword)
nmap <C-H> <Plug>(coc-float-hide)
noremap <C-C> 
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-plug,~/.vim/plugged/vim-fugitive,~/.vim/plugged/command-t,~/.vim/plugged/sparkup/vim,~/.vim/plugged/webapi-vim,~/.vim/plugged/gist-vim,~/.vim/plugged/ale,~/.vim/plugged/coc.nvim,~/.vim/plugged/indentline,~/.vim/plugged/goyo.vim,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-commentary,~/.vim/plugged/rainbow_parentheses.vim,~/.vim/plugged/fsharp-vim,~/.vim/plugged/yats.vim,~/.vim/plugged/vimtex,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-markdown,~/.vim/plugged/rust.vim,~/.vim/plugged/vim-racket,~/.vim/plugged/vim-cython,~/.vim/plugged/vim-wenyan,~/.vim/plugged/purescript-vim,~/.vim/plugged/haskell-vim,~/.vim/plugged/vim-llvm,~/.vim/plugged/asyncrun.vim,~/.vim/plugged/vim-slime,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-srcery,~/.vim/plugged/wal.vim,~/.vim/plugged/ultisnips,~/.vim/plugged/vim-snippets,~/.vim/plugged/base16-vim,~/.vim/plugged/vim-colors-solarized,~/.vim/plugged/gruvbox,~/.vim/plugged/tender.vim,~/.vim/plugged/vim-carbon-now-sh,~/.vim/plugged/vim-taskwarrior,~/.vim/plugged/vim-startify,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vim82/pack/dist/opt/termdebug,/usr/share/vim/vimfiles/after,~/.vim/after,~/.opam/default/share/merlin/vim,~/.vim/plugged/indentline/after,~/.vim/plugged/vimtex/after,~/.vim/plugged/vim-markdown/after,~/.vim/plugged/rust.vim/after,~/.vim/plugged/haskell-vim/after,~/.vim/plugged/vim-llvm/after,~/.vim/plugged/ultisnips/after,~/.vim/autoload/plug.vim
set scrolloff=15
set shiftwidth=2
...
set splitbelow
set splitright
set statusline=%{coc#status()}%{get(b:,'coc_current_function','')}%f%=%y\ @%l,\ total:\ %L,\ In:\ %p%%
...
silent only
silent tabonly
cd ~/yeetDisk/docs/UBC03T2W/sENg/P2/COSC_310_A2/agent
...
normal! 0
tabnext 1
badd +12 src/fuzzy.py
badd +45 src/agent.py
badd +193 src/state.py
badd +45 static/dictoinary.json
badd +0 Session.vim
